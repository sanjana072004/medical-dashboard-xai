...
class CardiovascularModel(BaseModel):
    """XGBoost model for cardiovascular disease prediction"""
    ...
    SCALER_PATH = "models/cardiovascular_scaler.pkl"
    
    def __init__(self):
        super().__init__("cardiovascular_xgboost", "cardiovascular")
